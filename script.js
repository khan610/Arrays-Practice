...
const calcDisplaySummary = function (acc) {
  ...
  labelSumIn.textContent = `${interest}EUR`;
};
...
// // accumulator -> SNOWBALL -> zbir svih elementa u array
...
//   const average2 = adults.reduce((acc, age) => acc + age, 0);
...
// // AT METHOD
// // Getting the last array element 3 difrent ways
...
//   if (movement > 0) {
//     console.log(`Movement ${i + 1}: Upi deposited ${movement}`);
//   } else {
